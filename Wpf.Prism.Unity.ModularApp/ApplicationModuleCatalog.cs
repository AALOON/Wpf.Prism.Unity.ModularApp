...
{
    public class ApplicationModuleCatalog : IModuleCatalog
    {
        private readonly List<IModuleCatalog> _catalogs = new List<IModuleCatalog>();

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationModuleCatalog"/> class.
        /// </summary>
        public ApplicationModuleCatalog()
        {
        ...
        {
            var modulesGroupedByCatalog = modules.GroupBy<ModuleInfo, IModuleCatalog>(module => this._catalogs.Single(catalog => catalog.Modules.Contains(module)));
